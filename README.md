...
[Compatible Packages](#compatible-packages)<br>
...
```bash
php artisan vendor:publish --provider="JSCustom\LaravelImageResize\Providers\LaravelImageResizeServiceProvider" --tag="config"
```
...
```bash
JSCustom\LaravelImageResize\Models\User
JSCustom\LaravelImageResize\Models\UserAddress
JSCustom\LaravelImageResize\Models\UserProfile
```
...
```bash
\JSCustom\LaravelImageResize\Http\Controllers\User\UserController
```
...
```bash
JSCustom\LaravelImageResize\Models\UserRole
```
...
```bash
\JSCustom\LaravelImageResize\Http\Controllers\UserRole\UserRoleController
```
